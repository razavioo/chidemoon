...
$product->update_meta_data( '_chidemoon_disclosure', 'این صفحه ممکن است پیوند همکاری داشته باشد؛ چیدمون در صورت خرید شما کمیسیون دریافت می‌کند و هزینه‌ی خرید افزایش نمی‌یابد.' );
...
cm_seed_term( 'post_tag', 'shop-the-look', 'شاپ‌درلوک', 'ترکیب‌های ادیتوریال که کالاهایشان مستقیم به فروشنده وصل می‌شود.' );
...
'slug'     => 'home',
'title'    => 'چیدمون',
'excerpt'  => 'خانه‌ای که با نیت چیده شده است؛ راهنماهای بررسی‌شده، مقایسه‌های شفاف و ترکیب‌های اتاق‌به‌اتاق برای تصمیم‌های واقعی خرید.',
'content'  => '<p>چیدمون یک مجله‌ی خرید برای خانه است، نه یک فروشگاه. ما کالا را نمی‌فروشیم؛ بررسی می‌کنیم، مقایسه می‌کنیم و شما را مستقیم به فروشنده می‌رسانیم. هر راهنما با معیارهای روشن نوشته می‌شود و هر مقایسه، مبادلات نامعلوم را پنهان نمی‌کند.</p><ul><li><strong>راهنمای خرید:</strong> معیارهای واقعی برای انتخاب مبل، نور و منسوجات</li><li><strong>مقایسه:</strong> روبه‌رو کردن گزینه‌ها با شواهد و بدون توصیه‌ی خودکار</li><li><strong>شاپ‌درلوک:</strong> ترکیب‌های ادیتوریال که هر کالایش مقصد مستقل دارد</li></ul>',
'image'    => array( '#173f35', '#b65d3d' ),
)
);
cm_seed_page( array( 'slug' => 'guides', 'title' => 'راهنماهای خرید', 'excerpt' => 'راهنماهای بررسی‌شده برای تصمیم‌های واقعی خرید؛ از مبل و نور تا منسوجات.', 'image' => array( '#173f35', '#9eab92' ) ) );
...
cm_seed_page( array( 'slug' => 'shop-the-look', 'title' => 'شاپ‌درلوک', 'excerpt' => 'اتاق‌ها را ببینید و هر کالا را مستقیم از فروشنده‌ی آن بخرید.', 'image' => array( '#b65d3d', '#e2b19d' ) ) );
