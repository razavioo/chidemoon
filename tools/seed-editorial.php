...
cm_seed_term( 'post_tag', 'shop-the-look', 'از تصویر بخر', 'ترکیب‌های ادیتوریال که محصولاتشان مستقیم به فروشنده وصل می‌شود.' );
...
cm_seed_page( array( 'slug' => 'shop-the-look', 'title' => 'از تصویر بخر', 'excerpt' => 'اتاق‌ها را ببینید و هر محصول را مستقیم از فروشنده‌ی آن بخرید.', 'image' => array( '#b65d3d', '#e2b19d' ) ) );
