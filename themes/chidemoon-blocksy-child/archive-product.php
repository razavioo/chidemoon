...
// Sorting is an editorial chip row inside the archive masthead (see
// chidemoon_blocksy_render_catalogue_sort), so the detached <select>
// toolbar never renders above the loop.
	...
	<section class="chidemoon-shop-archive__intro chidemoon-section-shell<?php echo $term_thumbnail_id > 0 || '' !== $term_art || $hero_product instanceof WC_Product ? ' has-media' : ''; ?>">
		<div class="chidemoon-shop-archive__intro-copy">
			...
			<?php if ( woocommerce_product_loop() ) : ?>
				<?php chidemoon_blocksy_render_catalogue_sort(); ?>
			<?php endif; ?>
		</div>
