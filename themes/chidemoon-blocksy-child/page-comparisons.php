	...
	<?php if ( $core_ready ) : ?>
		...
		<section id="chidemoon-comparison-picker" class="chidemoon-comparison-picker chidemoon-section-shell" aria-labelledby="chidemoon-picker-title">
			...
			<ol class="chidemoon-comparison-steps">
				<li><div class="chidemoon-comparison-steps__badge chidemoon-comparison-steps__badge--sage"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M6 8h12l-1.2 12H7.2L6 8Z"></path><path d="M9 8V6a3 3 0 0 1 6 0v2"></path></svg><span class="chidemoon-comparison-steps__num" aria-hidden="true">۱</span></div><div class="chidemoon-comparison-steps__copy"><p class="chidemoon-comparison-steps__title"><?php esc_html_e( 'محصول را انتخاب کنید', 'chidemoon-blocksy-child' ); ?></p><p class="chidemoon-comparison-steps__desc"><?php esc_html_e( 'از کالاهای بررسی‌شده، تا چهار گزینه بچینید.', 'chidemoon-blocksy-child' ); ?></p></div></li>
				<li><div class="chidemoon-comparison-steps__badge chidemoon-comparison-steps__badge--forest"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="m5 3 6.5 16 2.3-6.2L20 10.5 5 3Z"></path><path d="m12.5 15.5 4.5 4.5"></path></svg><span class="chidemoon-comparison-steps__num" aria-hidden="true">۲</span></div><div class="chidemoon-comparison-steps__copy"><p class="chidemoon-comparison-steps__title"><?php esc_html_e( 'روی «مقایسه» بزنید', 'chidemoon-blocksy-child' ); ?></p><p class="chidemoon-comparison-steps__desc"><?php esc_html_e( 'دکمهٔ «مقایسه» روی هر کارت محصول هست.', 'chidemoon-blocksy-child' ); ?></p></div></li>
				<li><div class="chidemoon-comparison-steps__badge chidemoon-comparison-steps__badge--clay"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3" y="4" width="18" height="16" rx="2"></rect><path d="M3 10h18"></path><path d="M9 10v10"></path><path d="M15 10v10"></path></svg><span class="chidemoon-comparison-steps__num" aria-hidden="true">۳</span></div><div class="chidemoon-comparison-steps__copy"><p class="chidemoon-comparison-steps__title"><?php esc_html_e( 'جدول را ببینید', 'chidemoon-blocksy-child' ); ?></p><p class="chidemoon-comparison-steps__desc"><?php esc_html_e( 'قیمت و مشخصات‌ها، یک‌جا کنار هم.', 'chidemoon-blocksy-child' ); ?></p></div></li>
			</ol>
